...
export function FooterCTA() {
  ...
  return (
    <section id="contact" className="section" style={{ backgroundColor: '#f2f0eb' }}>
      <motion.div
        ...
        style={{
          borderRadius: 28,
          minHeight: 380,
          boxShadow: '0 0 0 1px rgba(255,255,255,0.1) inset, 0 24px 80px rgba(54,38,167,0.3)',
        }}
      >
        {/* Background layers */}
        <Image
        ...
        {/* Content */}
        <div
          className="relative z-10 flex flex-col md:flex-row items-center w-full flex-wrap px-6 py-8 md:px-[72px] md:py-[80px] gap-6 md:gap-10"
        >
          {/* Left side */}
          <motion.div
          ...
          >
            <p
              ...
              style={{ fontSize: 13, letterSpacing: '0.15em', color: 'rgba(255,255,255,0.4)', marginBottom: 16 }}
            >
              {t('kicker')}
            </p>
            <h2
            ...
            <p className="font-sans md:whitespace-nowrap" style={{ fontSize: 16, color: 'rgba(255,255,255,0.55)' }}>
              {t('sub')}
            </p>
          </motion.div>
          ...
          >
            ...
            >
              <input
                ...
                style={{ color: 'white', fontSize: 13, height: 52, padding: '0 14px' }}
              />
              <button
                type="button"
                onClick={handleSubmit}
                className="font-sans font-extrabold whitespace-nowrap cursor-pointer"
