...
const inputClass =
  'w-full px-[14px] py-3 bg-[#FBF9FF] border-[1.5px] border-[#e8e8e4] rounded-[10px] font-sans text-sm text-[#0a0a0a] outline-none transition-colors duration-200 focus:border-[#3626A7] focus:bg-white';
